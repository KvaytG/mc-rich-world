...
public enum Permissions {
    ...
    FLY_ME(config -> config.getPermission("flyMe", "fly", "me")),
    FLY_OTHERS(config -> config.getPermission("flyOthers", "fly", "others")),
    MUTE_USE(config -> config.getPermission("muteUse", "mute", "use")),
    UNMUTE_USE(config -> config.getPermission("unmuteUse", "unmute", "use"));
